...
#import "ScenarioNameSetUpCell.h"

@implementation ScenarioNameSetUpCell
...
- (void)initWithCell{
    ...
    self.ScenarioNameLab = [[UILabel alloc]init];
    self.ScenarioNameLab.textColor =AllBulbTitleColor;
    self.ScenarioNameLab.font = [UIFont systemFontOfSize:15];
    [self.contentView addSubview:self.ScenarioNameLab];
    [self.ScenarioNameLab mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)setTitle:(NSString *)title{
    _title = title;
    self.ScenarioNameLab.text = title;
}
